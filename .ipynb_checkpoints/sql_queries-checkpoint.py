...
session_id,location) VALUES (%s,%s,%s,%s,%s,%s,%s)
""")
...
#Copy data in bulk
song_copy="""COPY songs FROM STDOUT WITH DELIMITER AS '\t' CSV HEADER"""
artist_copy="""COPY artists FROM STDOUT WITH DELIMITER AS '\t' CSV HEADER"""
time_copy="""COPY time FROM STDOUT WITH DELIMITER AS '\t' CSV HEADER"""
user_copy="""COPY users FROM STDOUT WITH DELIMITER AS '\t' CSV HEADER"""
songplay_copy="""COPY songplay FROM STDOUT WITH DELIMITER AS '\t' CSV HEADER"""
